...
INSERT INTO `barangay_assessment` (`keyctr`, `barangay_id`, `comments`, `status`, `last_modified`) VALUES
(1, '104201009', '[{\"name\":\"admin\",\"comment\":\"test comment\",\"timestamp\":1736651109},{\"name\":\"admin\",\"comment\":\"another test comment\",\"timestamp\":1736651125}]', 'approved', '2025-01-12 11:05:25'),
(2, '104201018', '[{\"name\":\"admin\",\"comment\":\"asda\",\"timestamp\":1736661276}]', 'approved', '2025-01-12 13:54:36');
...
(10, 'sss', 'Created at 2024-11-22 05:34:47');
...
(25, 1, 1, 1, 1, '                Note: BFDP Monitoring Form A can be\r\naccessed through the link:       1         ', 1, '                sdasd      1                '),
(27, 1, 11, 19, 1, 'asdasd', 1, '111'),
(29, 1, 1, 1, 1, 'asdasdasd', 1, ''),
(30, 1, 1, 1, 0, 'dfdfghjkl', 1, ''),
(31, 1, 31, 85, 1, '                asdasdas         1                ', 1, '                                ');
...
ALTER TABLE `user_roles_barangay`
  ADD PRIMARY KEY (`user_id`,`barangay_id`,`criteria_id`,`version_id`),
...
--
ALTER TABLE `maintenance_area`
  MODIFY `keyctr` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `maintenance_area_description`
--
ALTER TABLE `maintenance_area_description`
  MODIFY `keyctr` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `maintenance_area_indicators`
--
ALTER TABLE `maintenance_area_indicators`
  MODIFY `keyctr` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
ALTER TABLE `user_roles_barangay`
  ...
  ADD CONSTRAINT `user_roles_barangay_ibfk_2` FOREIGN KEY (`barangay_id`) REFERENCES `refbarangay` (`brgyid`),
  ADD CONSTRAINT `user_roles_barangay_ibfk_3` FOREIGN KEY (`criteria_id`) REFERENCES `maintenance_criteria_setup` (`keyctr`),
  ADD CONSTRAINT `user_roles_barangay_ibfk_4` FOREIGN KEY (`version_id`) REFERENCES `maintenance_criteria_setup` (`version_keyctr`);
COMMIT;
